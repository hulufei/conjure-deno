...
table.insert(cfts, "javascriptreact")
table.insert(cfts, "typescriptreact")
...
vim.g["conjure#filetype#typescriptreact"] = "conjure.client.deno.stdio"
vim.g["conjure#filetype#javascriptreact"] = "conjure.client.deno.stdio"
